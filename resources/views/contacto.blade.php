    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center">
                ...
                <div class="sidebar-brand-text mx-3">Landing page</div>
            </a>
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <!-- Nav Item - Alerts -->
                        <!-- Aquí va el include de alerts -->

                        <!-- Nav Item - Messages -->
                        <!-- Aquí va el include de messages -->
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <div align="center">
                        <h1 class="h3 mb-4 text-gray-800">Contacto</h1>
                        <link
                        ...
                        <script src="{{ asset('js/init-alpine.js') }}"></script>
                            ...
                            <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                                ...
                                <label class="block text-sm">
                                    ...
                                    <input
                                        class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                        type="text" name="apellidos" value=""
                                    />
                                </label>
                                ...
                                <label class="block text-sm">
                                    ...
                                    <textarea
                                        class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                        type="date" name="comentario" value=""
                                    >
                                    </textarea>
                                </label>
